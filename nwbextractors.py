...
def read_file_from_backend(
    *,
    ...
    file: BinaryIO | h5py.File | None = None,
    ...
    """
    if isinstance(file, h5py.File) or isinstance(file, lindi.LindiH5pyFile):
        return file
...
class NwbRecordingExtractor(BaseRecording, _BaseNWBExtractor):
    ...
    def __init__(
        ...
        *,
        file: BinaryIO | h5py.File | None = None,  # file-like - provide either this or file_path
        cache: bool = False,
        storage_options: dict | None = None,
